...
public class Day14RiddleRunner {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        "First riddle solution: " + riddleSolver.solveRiddleOne(input, gridWidth, gridHeight));
    System.out.println(
        "Second riddle solution: " + riddleSolver.solveRiddleTwo(input, gridWidth, gridHeight));
  }
}
